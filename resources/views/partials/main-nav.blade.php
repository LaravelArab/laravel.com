<li class="nav-docs"><a href="/docs">التوثيق</a></li>
<li class="nav-laracasts"><a href="https://laracasts.com">Laracasts</a></li>
<li class="nav-laravel-news"><a href="https://laravel-news.com">أخبار</a></li>
...
<li class="dropdown community-dropdown">
	<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
	Ecosystem <span class="caret"></span></a>
	<ul class="dropdown-menu" role="menu">
		...
		<li class="divider"></li>
		<li><a href="https://laracasts.com/discuss">منتديات</a></li>
		<li><a href="https://larajobs.com/?partner=5#/">فرص عمل</a></li>
